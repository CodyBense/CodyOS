      ...
      ''
        * {
        ...
        #clock {
          font-weight: bold;
          color: #${config.stylix.base16Scheme.base00};
          background: linear-gradient(45deg, #${config.stylix.base16Scheme.base0C}, #${config.stylix.base16Scheme.base0F}, #${config.stylix.base16Scheme.base0B}, #${config.stylix.base16Scheme.base08});
          background-size: 300% 300%;
          margin: 0px;
